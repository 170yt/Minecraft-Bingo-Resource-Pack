import os
from generator import generate_default_resource_pack, copy_icons_from_icon_exporter_mod, get_advancements_per_category, generate_advancement_item_models, copy_advancement_icons_from_icon_exporter_mod, generate_font_file_and_mappping
...
generate_font_file_and_mappping(BASE_DIR, RESOURCE_PACK_FOLDER)
